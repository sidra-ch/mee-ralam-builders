 ...
 *
 * Subtle fixed-position WhatsApp icon button (bottom-right).
 * Opens WhatsApp click-to-chat with a pre-filled enquiry message.
 * Enhanced with restrained magnetic micro-interaction.
 */
